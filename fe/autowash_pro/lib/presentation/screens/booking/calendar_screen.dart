                        ...
                        Container(
                          ...
                          child: TableCalendar(
                            ...
                            calendarStyle: CalendarStyle(
                              defaultDecoration: BoxDecoration(shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(12)),
                              weekendDecoration: BoxDecoration(shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(12)),
                              outsideDecoration: BoxDecoration(shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(12)),
                              disabledDecoration: BoxDecoration(shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(12)),
                              todayDecoration: BoxDecoration(color: Colors.transparent, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(12)),
                              todayTextStyle: GoogleFonts.outfit(color: AppTheme.primaryBlue, fontWeight: FontWeight.bold),
                              selectedDecoration: BoxDecoration(color: AppTheme.primaryBlue, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(12)),

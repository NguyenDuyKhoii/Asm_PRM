...
class _MyBookingsScreenState extends State<MyBookingsScreen> {
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        // View checklist progress and photos button
                                        if (booking.status.toLowerCase() == 'completed' || booking.status.toLowerCase() == 'inprogress') ...[
                                          const SizedBox(height: 12),
                                          SizedBox(
                                            width: double.infinity,
                                            child: OutlinedButton.icon(
                                              onPressed: () => _showChecklistBottomSheet(context, booking),
                                              icon: const Icon(Icons.photo_library_rounded, size: 16),
                                              label: Text('Xem tiến độ & Ảnh nghiệm thu', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 13)),
  ...
  void _showChecklistBottomSheet(BuildContext context, BookingListModel booking) {
    Map<String, String> resolvedDefaults = {};
    final lower = booking.serviceName.toLowerCase();
    ...
    final tasks = ChecklistTaskModel.fromJsonString(booking.checklist, resolvedDefaults);
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${booking.serviceName}  |  Xe: ${booking.vehiclePlate}',
                          style: GoogleFonts.outfit(
                            fontSize: 13,
